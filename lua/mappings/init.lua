...
-- Bufferline keymaps
vim.api.nvim_set_keymap("n", "<Tab>", ":BufferLineCycleNext<Enter>", {noremap = true})
vim.api.nvim_set_keymap("n", "<S-Tab>", ":BufferLineCyclePrev<Enter>", {noremap = true})

vim.api.nvim_set_keymap("n", "<Space>,", ":BufferLinePickClose<Enter>", {noremap = true})
